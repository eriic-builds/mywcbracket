...
export const CELEBRATION_TIMING = Object.freeze({
  ...
  captainEntryEnd: 4.8,
  trophyApproachStart: 4.8,
  trophyApproachEnd: 6.9,
  trophyGrabStart: 6.9,
  trophyGrabEnd: 9,
  carryStart: 9,
  carryEnd: 11.6,
  ...
  captainFrontStart: 14.66,
  captainFrontEnd: 15.5,
  teamAnticipationStart: 15.5,
  teamAnticipationEnd: 16.9,
  trophyLiftEnd: 18.9,
  jumpStart: 17.08,
  jumpEnd: 19.5,
  flaresStart: 17.1,
...
const TROPHY_GRIP_X = 0.34;
const TROPHY_GRIP_Y = -1.38;
const TROPHY_GRIP_Z = 0.08;
