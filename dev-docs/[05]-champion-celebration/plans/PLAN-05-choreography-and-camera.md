...
- `dev-docs/[00]-dev-reports/[05]-champion-celebration/mock.js` - synchronize paused-WAAPI curtain timing, connector
  halves, plinth dismissal, and deterministic review controls.
- `dev-docs/[00]-dev-reports/[05]-champion-celebration/mock.css` - remove old simultaneous column/dissolve rules now
  owned by WAAPI.
