...
[`SOURCE_BRIEF.md`](SOURCE_BRIEF.md). This package's
...
- [Interactive review](../[00]-dev-reports/[05]-champion-celebration/) - local controls for playing and
...
```text
http://127.0.0.1:8000/dev-docs/[00]-dev-reports/[05]-champion-celebration/?scoutTheme=dark
```
