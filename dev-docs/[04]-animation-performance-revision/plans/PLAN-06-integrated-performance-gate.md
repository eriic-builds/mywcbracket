...
- `dev-docs/[04]-animation-performance-revision/RESULTS.md` - new final comparison report.
- `dev-docs/[00]-dev-reports/[04]-animation-performance-revision/index.html` - publish verified outcomes
...
13. Turn the interactive planning guide into the final execution report at
    `dev-docs/[00]-dev-reports/[04]-animation-performance-revision/index.html`. Keep the existing
    ...
    Keep it under `dev-docs/[00]-dev-reports/` so GitHub Pages renders the dashboard instead of
