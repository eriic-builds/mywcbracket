...
- For larger, multi-plan workstreams, follow the established `dev-docs/<brief-name>/` package pattern (`BRIEF.md`, optional `BASELINE.md`, `plans/`, `RESULTS.md`, `README.md`) and publish interactive reports under `dev-docs/[00]-dev-reports/<brief-name>/`.
